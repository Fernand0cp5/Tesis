...
Gs6 = 3600*roe*s0*L*U; % Tonalaje tratado: Gs en [ton/hora]
...
n = 13;
faHPGR(1) = 0.01734;%0.0239; %fracción retenido discreto, tamaño 45.000 [mm]
faHPGR(2) = 0.2948;%0.4001; %fracción retenido discreto, tamaño 31.500 [mm]
faHPGR(3) = 0.2654;%0.2089; %fracción retenido discreto, tamaño 22.400 [mm]
faHPGR(4) = 0.1315;%0.1090; %fracción retenido discreto, tamaño 16.000 [mm]
faHPGR(5) = 0.07746;%0.0549; %fracción retenido discreto, tamaño 11.200 [mm]
faHPGR(6) = 0.06721;%0.0441; %fracción retenido discreto, tamaño 8.000 [mm]
faHPGR(7) = 0.07007;%0.0542; %fracción retenido discreto, tamaño 5.600 [mm]
faHPGR(8) = 0.02725;%0.0374; %fracción retenido discreto, tamaño 2.800 [mm]
faHPGR(9) = 0.01154;%0.0159; %fracción retenido discreto, tamaño 1.000 [mm]
faHPGR(10) = 0.006167;%0.0085; %fracción retenido discreto, tamaño 0.500 [mm]
faHPGR(11) = 0.006385;%0.0088; %fracción retenido discreto, tamaño 0.315 [mm]
faHPGR(12) = 0.006167;%0.0085; %fracción retenido discreto, tamaño 0.200 [mm]
faHPGR(13) = 0.01872;%0.0258; %fracción retenido discreto, tamaño 0.125 [mm]
aa=sum(faHPGR(1:13))
